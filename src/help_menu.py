...
class HelpMenu(Menu):
    ...
    def _create_control_windows(self, ai_game):
        ...
        self.basic_control_windows = (
            ...
            self.basic_control_window1,
            self.basic_control_window2,
            self.basic_control_window3,
            self.basic_control_window4,
        )
    ...
    def _create_score_windows(self, ai_game):
        ...
        self.basic_score_windows = (
            ...
            self.basic_score_window1,
            self.basic_score_window2,
            self.basic_score_window3,
            self.basic_score_window4,
            self.basic_score_window5,
            self.basic_score_window6,
        )
    ...
    def _create_misc_windows(self, ai_game):
        ...
        self.basic_misc_windows = (
            ...
            self.basic_misc_window1,
            self.basic_misc_window2,
            self.basic_misc_window3,
            self.basic_misc_window4,
    ...
    def _create_enemy_windows(self, ai_game):
        ...
        self.basic_enemy_windows = (
            ...
            self.basic_enemy_window1,
            self.basic_enemy_window2,
            self.basic_enemy_window3,
            self.basic_enemy_window4,
    ...
    def _create_adv_enemy_windows(self, ai_game):
        ...
        self.adv_enemy_windows = (
            ...
            self.adv_enemy_window1,
            self.adv_enemy_window2,
            self.adv_enemy_window3,
            self.adv_enemy_window4,
            self.adv_enemy_window5,
            self.adv_enemy_window6,
            self.adv_enemy_window7,
