...
class Button:
    ...
    def __init__(
        ...
        self.top_rect.center = (
            self.screen_rect.centerx - x_offset,
    ...
    def _set_button_properties(self, width, height, font_size, small_font):
        """Set the size, color, and font of the button."""
    ...
    def _prep_msg(self, msg):
        ...
        self.msg_image = self.font.render(msg, False, self.text_color, self.top_button_color)
    ...
    def check_mouse_click(self):
        """Check if left or right mouse clicked on the button."""
    ...
    def set_color(self, button_color, msg="", msg_size=48):
        """Receive a color value and adjusts the color of the button based on the values."""
