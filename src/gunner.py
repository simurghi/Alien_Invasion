...
class Gunner(Sprite):
    ...
    def _make_game_objects(self, ai_game):
        """Make the objects necessary for the gunner to function."""
        self.game = ai_game
    ...
    def _set_gunner_stats(self):
        """Set the combat stats for the gunner."""
        self.hitpoints = 9
        self.berserk = False
    ...
    def _set_initial_coordinates(self):
        """Set the initial coordinates for gunners and their rects."""
    ...
    def _fire_bullets(self):
        """Create new bullets based on a cooldown."""
    ...
    def _show_damage(self):
        """Update the image of the gunner if it's low on HP."""
        if self.hitpoints < 5:
